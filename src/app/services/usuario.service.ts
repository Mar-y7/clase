...
export class UsuarioService {
  ...
  constructor(private storage: Storage) { 
    this.inicializar_storage ();
  }
//método: asincrónico
//acción:await

  async inicializar_storage(){
    await this.storage.create(); //si no existe este comando no se puede crear usuarios. Es conveniente crearlo en un método
  }
